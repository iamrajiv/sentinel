/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cae2b7c6be22aabcd15cd5104a0af16a)
// Runtime types generated with workerd@1.20260911.1 2026-09-11 nodejs_compat
interface __BaseEnv_Env {
	AI: Ai;
	ASSETS: Fetcher;
	SENTINEL_MODEL: "@cf/meta/llama-3.3-70b-instruct-fp8-fast";
	SENTINEL_ENV: "development";
	CodexAgent: DurableObjectNamespace<import("./src/server").CodexAgent>;
	REVIEW_WORKFLOW: Workflow<Parameters<import("./src/server").ReviewWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SENTINEL_MODEL" | "SENTINEL_ENV">> {}
}
